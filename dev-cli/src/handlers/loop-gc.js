/**
 * handlers/loop-gc.js — dev-cli loop-gc [--max-age <hours>]
 *
 * Garbage collect old completed/abandoned loops.
 * Default max age: 24 hours.
 *
 * stdout: JSON { removed }
 */

import { gcLoops } from '../core/loop-state.js';
...
export default async function handler(args) {
  ...
  const removed = gcLoops(maxAgeMs);
